  ...
  const buttonsPrinter = [
    {
      ...
      onPress: () =>
        navigation.navigate('PrinterText', {
          conectionType: printerConectionType,
        }),
    },
    {
      id: 'BARCODE',
      ...
      onPress: () =>
        navigation.navigate('PrinterBarCode', {
          conectionType: printerConectionType,
        }),
    },
    {
      ...
      onPress: () =>
        navigation.navigate('PrinterImage', {
          conectionType: printerConectionType,
        }),
    },
  ];
  const functionButtons = [
    {
      ...
      textButton: 'STATUS IMPRESSORA',
      onPress: () => actualStatusPrinter(),
    },
    {
      id: 'GAVETA',
      icon: require('../icons/status.png'),
      textButton: 'STATUS GAVETA',
